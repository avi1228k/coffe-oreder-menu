...
public class OrangeSmoothi extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.orangrsmoothi);
        ...
        drinnkName.setText("Orange Smoothi");
        imageView.setImageResource(R.drawable.orange);
        addtoCart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(OrangeSmoothi.this, SummaryActivity.class);
        ...
        plusquantity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                coffeePrice.setText( ifCheckBox +"Rs " );
        ...
        minusquantity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (quantity == 0) {
                    Toast.makeText(OrangeSmoothi
                            .this, "Cant decrease quantity < 0", Toast.LENGTH_SHORT).show();
                } else {
                    quantity--;
                    displayQuantity();
                    int coffePrice = basePrice * quantity;
